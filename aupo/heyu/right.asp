...
<table width="100%" border="0" align="center" cellpadding="10" cellspacing="1" bgcolor="#cad9ea" >
  <tr>
    <td align="right" bgcolor="#f5fafe" class="main_bleft" width="250">版本信息：</td>
    <td bgcolor="#FFFFFF" class="main_bright">v1.8.3 旗舰版（<a href="http://www.alovestory.cn/" target="_blank">查看更新</a>）</td>
  </tr>
  <tr>
    <td align="right" bgcolor="#f5fafe" class="main_bleft">授权信息</td>
    <td bgcolor="#FFFFFF" class="main_bright">已授权商业使用</td>
  </tr>
  <tr>
