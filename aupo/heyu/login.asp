...
<div class="login">
	<div class="menus">
    	<div class="public"><a href="http://www.he-yu.net" target="_blank">使用帮助</a><a href="http://www.he-yu.net" target="_blank">联系开发者</a></div>
    </div>
    <div class="box png">
        ...
        <ul>
			...
			<%end if%>
			<li style="display:none;"><label>类型</label><input name="atype" type="radio" value="1" />简单版  <input name="atype" type="radio" value="0" checked="checked" />全功能版</li> 
