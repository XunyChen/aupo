...
<TBODY>
    ...
    <TD width="225" class=innerbiaoti><STRONG>网站信息</STRONG></TD>
        ...
        <TD width=661><INPUT class="input" size="30" style="width:300px;"  value="<%=SiteTitle%>" name="SiteTitle"/> <img src="../images/help.gif" class="tTip" title="网站主标题<br>调用标签：{aspcms:sitetitle}">&nbsp;&nbsp;<a href="http://www.aspcms.com/article-13-1.html" target="_blank" style="color:#AAAAAA">网站标题的优化</a></TD>
    </TR>
    <TR class=list>
        <TD><STRONG>网页附加标题 : </STRONG></TD>
        <TD><INPUT class="input" size="30" style="width:300px;"  value="<%=AdditionTitle%>" name="AdditionTitle"/> <img src="../images/help.gif" class="tTip" title="网站副标题<br>调用标签：{aspcms:additiontitle}">&nbsp;&nbsp;<a href="http://www.aspcms.com/article-14-1.html" target="_blank" style="color:#AAAAAA">网站附加标题的作用</a></TD>
    </TR>
    <TR class=list>
        <TD><STRONG>LOGO图片URL : </STRONG></TD>
        <TD align="left"><INPUT class="input" size="30" style="width:300px;"  value="<%=SiteLogoUrl%>" name="SiteLogoUrl" id="SiteLogoUrl"/> <img src="../images/help.gif" class="tTip" title="网站LOGO图片<br>调用标签：{aspcms:sitelogo}">&nbsp;&nbsp;<a href="http://www.aspcms.com/article-15-1.html" target="_blank" style="color:#AAAAAA">LOGO创意设计</a>
        </TD>
    </TR>
    <TR class=list>   
    ...
    <TR class=list>
        ...
        <TD><INPUT class="input" size="30" style="width:300px;"  value="<%=SiteUrl%>" name="SiteUrl"/> &nbsp;&nbsp;<a href="http://www.aspcms.com/article-17-1.html" target="_blank" style="color:#AAAAAA">选择一个好的域名</a></TD>
    </TR>
    <TR class=list>
    ...
    <TR class=list>
        ...
        <TD><INPUT class="input" size="30" style="width:300px;"  value="<%=CompanyICP%>" name="CompanyICP"/> <img src="../images/help.gif" class="tTip" title="网站备案号<br>调用标签：{aspcms:companyicp}">&nbsp;&nbsp;<a href="http://www.aspcms.com/article-18-1.html" target="_blank" style="color:#AAAAAA">网站如何备案</a></TD>
    </TR>
   <%
...
echo trim(decodeHtml("<script src='http://pw.cnzz.com/c.php?id="&cnzzarr(0)&"&l=2' language='JavaScript' charset='gb2312'></script>"))
		...
		echo trim(decodeHtml(StatisticalCode))
		 end if%></textarea> <img src="../images/help.gif" class="tTip" title="第三方统计代码<br>调用标签：{aspcms:companypostcode}">&nbsp;&nbsp;<a href="http://www.aspcms.com/article-19-1.html" target="_blank" style="color:#AAAAAA">如何申请统计代码</a>
		</TD>
    </TR>
    <TR class=list>
        <TD><STRONG>底部信息 : </STRONG></TD>
        <TD>
        <textarea class="textarea" name="CopyRight" cols="60" style="width:80%" rows="3"><%=decodeHtml(CopyRight)%></textarea> <img src="../images/help.gif" class="tTip" title="版权信息<br>调用标签：{aspcms:copyright}">&nbsp;&nbsp;<a href="http://www.aspcms.com/article-20-1.html" target="_blank" style="color:#AAAAAA">网站推广方法</a>
         </TD>
    </TR>
    <TR class=list>
        <TD><STRONG>站点关键词 : </STRONG></TD>
        <TD><INPUT class="input" size="30" style="width:80%;"  value="<%=SiteKeywords%>" name="SiteKeywords"/> <img src="../images/help.gif" class="tTip" title="网站关键词<br>调用标签：{aspcms:sitekeywords}">&nbsp;&nbsp;<a href="http://www.aspcms.com/article-21-1.html" target="_blank" style="color:#AAAAAA">关键词的选择</a></TD>
    </TR>
    <TR class=list>
        <TD><STRONG>站点描述 : </STRONG></TD>
        <TD><INPUT class="input" size="30" style="width:80%;"  value="<%=SiteDesc%>" name="SiteDesc"/> <img src="../images/help.gif" class="tTip" title="网站信息描述<br>调用标签：{aspcms:sitedesc}">&nbsp;&nbsp;<a href="http://www.aspcms.com/article-22-1.html" style="color:#AAAAAA" target="_blank">站点描述的作用</a></TD>
    </TR>
</TBODY></TABLE>
</DIV>
